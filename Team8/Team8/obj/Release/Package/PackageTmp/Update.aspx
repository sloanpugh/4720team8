        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style51">
                    <asp:CheckBox ID="cb_Address" runat="server" AutoPostBack="True" OnCheckedChanged="cb_Address_CheckedChanged" TextAlign="Left" />
                </td>
                ...
                <td class="auto-style54">
                    <asp:TextBox ID="txt_Address" runat="server" OnTextChanged="txt_Address_TextChanged" Width="300px"></asp:TextBox>
                </td>
            ...
            <tr>
                <td class="auto-style51">
                    <asp:CheckBox ID="cb_City" runat="server" AutoPostBack="True" OnCheckedChanged="cb_City_CheckedChanged" TextAlign="Left" />
                </td>
                ...
                <td class="auto-style54">
                    <asp:TextBox ID="txt_City" runat="server" OnTextChanged="txt_City_TextChanged" Width="300px"></asp:TextBox>
                </td>
                <td class="auto-style55">
                    &nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style51">
                    <asp:CheckBox ID="cb_State" runat="server" AutoPostBack="True" OnCheckedChanged="cb_State_CheckedChanged" TextAlign="Left" />
                </td>
                ...
                <td class="auto-style54">
                    <asp:TextBox ID="txt_State" runat="server" OnTextChanged="txt_State_TextChanged" Width="300px"></asp:TextBox>
                </td>
                <td class="auto-style55">
                    &nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style51">
                    <asp:CheckBox ID="cb_Zip" runat="server" AutoPostBack="True" OnCheckedChanged="cb_Zip_CheckedChanged" TextAlign="Left" />
                </td>
                ...
                <td class="auto-style54">
                    <asp:TextBox ID="txt_Zip" runat="server" OnTextChanged="txt_Zip_TextChanged" Width="300px"></asp:TextBox>
                </td>
                <td class="auto-style55">
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style72">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:F22Team8ConnectionString %>" DeleteCommand="DELETE FROM [Customers] WHERE [Email] = @Email" InsertCommand="INSERT INTO [Customers] ([Email], [Address], [City], [State], [Zip], [FirstName], [LastName], [Password]) VALUES (@Email, @Address, @City, @State, @Zip, @FirstName, @LastName, @Password)" SelectCommand="SELECT * FROM [Customers] WHERE ([Email] = @Email)" UpdateCommand="UPDATE [Customers] SET [Address] = @Address, [City] = @City, [State] = @State, [Zip] = @Zip, [FirstName] = @FirstName, [LastName] = @LastName, [Password] = @Password WHERE [Email] = @Email">
                        <DeleteParameters>
                            <asp:Parameter Name="Email" Type="String" />
                        </DeleteParameters>
                        <InsertParameters>
